...
impl InitializationActor {
    ...
    pub fn new() -> Self {
        // Use default values provided by the Default derive
        // The commented block below shows the previous manual initialization
        /*
        Self {
        ...
        */ // Properly terminate the block comment
        Self::default() // Return the default instance
    }
